                    ...
                    <div class="col-12">
                        <nav aria-label="Page navigation">
                            <ul class="pagination pagination-lg justify-content-center bg-white mb-0"
                                ...
                                <li class="page-item "><a class="page-link" href="index.php?controller=posts&action=home">1</a></li>
                                  <?php 
                                    $sotrang =(int)($total/6);
                                    if($sotrang*6<$total)
                                      $sotrang++;
                                    ...
                                    for($i=2;$i<=$sotrang;$i++){
                                      echo  '<li class="page-item"><a class="page-link" href="index.php?controller=posts&action=home&page='.$i.'">'.$i.'</a></li>';
                                    }
                                  ?>
                                  <li class="page-item">
