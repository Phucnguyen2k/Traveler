        ...
        <div class="container-lg position-relative p-0 px-lg-3" style="z-index: 9;">
            ...
            <img src="assets/img/logo.png" width="35px" alt="" class="">
                <a href="index.php" class="navbar-brand">    
                    <h1 class="m-0 text-primary">A<span class="text-dark">nime</span>W<span class="text-dark">orld</span></h1>
                </a>
                ...
                <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                    <div class="navbar-nav ml-auto py-0">
                        ...
                        <a href="index.php?controller=pages&action=services"
                            class="nav-item nav-link">Anime</a>
                        <a href="index.php?controller=pages&action=package" class="nav-item nav-link">Light Novels</a>
                            <a href="index.php?controller=posts&action=home#" class="nav-item nav-link">Anime Reviews</a>
                    </div>
                </div>
            </nav>
        </div>
    ...
    <div class="container-fluid bg-dark text-white-50 py-5 px-sm-3 px-lg-5" style="margin-top: 90px;">
        <div class="row pt-5">
            ...
            <div class="col-lg-3 col-md-6 mb-5">
                ...
                <p><i class="fa fa-map-marker-alt mr-2"></i>123 Anime Street, Otaku City, Japan</p>
